...
# What This Script Is
This script is a utility tool to help with inspecting PcbDoc object properties.
...
_Step 3_: Select objects on the PcbDoc and run the `_Inspect` script procedure.
